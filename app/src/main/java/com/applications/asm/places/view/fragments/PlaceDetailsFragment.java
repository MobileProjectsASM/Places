...
public class PlaceDetailsFragment extends BaseFragment<FragmentPlaceDetailsBinding> {
    ...
    private void setListeners() {
        getViewBinding().showMapButton.setOnClickListener(view -> {
            mainViewModel.getPlaceMapVM().setValue(new PlaceMapVM(placeDetailsVM.getName(), placeDetailsVM.getCoordinatesVM(), placeDetailsVM.getAddress(), placeDetailsVM.getImageUrl()));
