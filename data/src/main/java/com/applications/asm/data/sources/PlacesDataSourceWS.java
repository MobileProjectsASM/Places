...
public interface PlacesDataSourceWS {
    ResponsePlacesModel getPlacesModel(String placeToFind, Double longitude, Double latitude, Integer radius, String categories, Integer initIndex, Integer amount) throws IOException, RuntimeException, PlacesDataSourceWSException;
